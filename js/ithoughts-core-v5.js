...
(function(s){
	 ...
	 * @returns {boolean} True if null or undefined, false otherwise
	 */
	v5.mergeRecursive = function(/* Any number of Object/Array */) {
		var newObj = null,
			j,
			curObj,
	...
	v5.docWidth = function(){
		return w.innerWidth ||
			w.documentElement.clientWidth ||
			w.body.clientWidth ||
			w.body.offsetWidth;
	}
	v5.docHeight = function(){
	 ...
	 */
	v5.gei = function(s,e) {return (e||d).getElementById(s); }
	/**
	 * @function qs
	 ...
	 */
	v5.qs = function(s,e) {return (e||d).querySelector(s); }
	/**
	 * @function qsa
	 ...
	 */
	v5.qsa = function(s,e) {return (e||d).querySelectorAll(s); }
	/**
	 * @function geiN
	 ...
	 */
	v5.geiN = function(s,e) {return gei(s,e) || {}; }
	/**
	 * @function qsN
	 ...
	 * @returns {Element|{}} The Element, or an empty object if not found
	 */
	v5.qsN = function(s,e) {return qs(s,e) || {}; }
	/**
	 * @function hop
	 ...
	 */
	v5.hop = function(s,v) {return s.hasOwnProperty(v); }
	/**
	 * @function waitUntil
