...
(function (s) {
  ...
  */
	v5.mergeRecursive = function () {
		...
		var newObj = null,
		    j,
		    curObj,
		    recurse = function recurse(obj1, obj2) {
			var i, newT;
  ...
  * @since 0.1.0
  */
	v5.on = v5.attachEvent = function (a, b, c) {
		/**
   * @function _on
  ...
  * @since 0.1.0
  */
	v5.off = v5.detachEvent = function (a, b, c) {
		/**
   * @function _off
  ...
  * @since 0.1.0
  */
	v5.go = v5.triggerEvent = function (a, b) {
		/**
   * @function _go
...
//# sourceMappingURL=ithoughts-core-v5.js.map
